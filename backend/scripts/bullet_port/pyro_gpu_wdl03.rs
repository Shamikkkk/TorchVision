/*
Pyro NNUE trainer — CANDIDATE D (03) of the July 12, 2026 WDL ladder (session 2a): SCReLU base, WDL blend 0.3.
...
fn main() {
    ...
    let schedule = TrainingSchedule {
        net_id: "pyro-gpu-wdl03".to_string(),
    ...
    let settings = LocalSettings {
        threads: 4,
        test_set: None,
        output_directory: "checkpoints/pyro-gpu-wdl03",
        batch_queue_size: 64,
    };
