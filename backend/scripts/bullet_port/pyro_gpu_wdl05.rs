/*
Pyro NNUE trainer — CANDIDATE D (05) of the July 12, 2026 WDL ladder (session 2a): SCReLU base, WDL blend 0.5.
...
fn main() {
    ...
    let schedule = TrainingSchedule {
        net_id: "pyro-gpu-wdl05".to_string(),
    ...
    let settings = LocalSettings {
        threads: 4,
        test_set: None,
        output_directory: "checkpoints/pyro-gpu-wdl05",
        batch_queue_size: 64,
    };
